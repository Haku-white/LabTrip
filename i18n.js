...
<section id="day1">
  ...
  <div class="timeline-item">
    ...
    <div class="event-body">
      ...
      <p class="note" style="margin-top:-2px; margin-bottom:10px;">🚶 α ⇄ β: about a 6-minute walk</p>
      <div class="rooms">
        <div class="room">
...
<section id="day1">
  ...
  <div class="timeline-item">
    ...
    <div class="event-body">
      ...
      <p class="note" style="margin-top:-2px; margin-bottom:10px;">🚶 α⇄β：徒歩約6分</p>
      <div class="rooms">
        <div class="room">
...
<section id="day1">
  ...
  <div class="timeline-item">
    ...
    <div class="event-body">
      ...
      <p class="note" style="margin-top:-2px; margin-bottom:10px;">🚶 α⇄β：步行约6分钟</p>
      <div class="rooms">
        <div class="room">
...
<section id="day1">
  ...
  <div class="timeline-item">
    ...
    <div class="event-body">
      ...
      <p class="note" style="margin-top:-2px; margin-bottom:10px;">🚶 α⇄β：步行約6分鐘</p>
      <div class="rooms">
        <div class="room">
